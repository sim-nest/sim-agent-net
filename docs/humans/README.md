...
| --- | --- | ---: | --- |
| `feature/sim-agent-net/agent-conduct-records` | `crate/sim-lib-agent-conduct-core` | 1 | Describe agent run frames, open lifecycle vocabulary, exact domain budgets, step Cards, and canonical hash-linked journals without loading execution behavior. |
| `feature/sim-agent-net/agent-conduct-topology-profile` | `crate/sim-lib-agent-conduct` | 1 | Certify delivered topology packages as agent/conduct-v1 workflows, bind their step Cards explicitly, and run or resume them through the topology engine. |
