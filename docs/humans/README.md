...
| `feature/sim-agent-net/durable-roadmap-execution-journal` | `crate/sim-lib-roadmap-runner` | 1 | Reduce canonical journal facts into cause-only semantic deltas, persistent evidence roots, verified snapshots, and explicit retention roots with effect-free fail-closed replay. |
